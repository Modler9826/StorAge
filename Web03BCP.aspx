<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web03BCP.aspx.cs" Inherits="StorAge.Web03BCP" %>
...
<body>
    ...
    <script type="text/javascript">   
        ...
        //数据来源
        var n1 = $("#HiddenField2").val();  //背胶大卷
        var n2 = $("#HiddenField3").val();  //单透大卷
        var n3 = $("#HiddenField4").val();  //硅纸
        var n4 = $("#HiddenField5").val();  //素纸
       ...
       // 指定图表的配置项和数据
            ...
            series: [
                {
                    ...
                    center: ['50%', '60%'],
                    data: [
                        { value: n1, name: '1.背胶大卷' },
                        { value: n2, name: '2.单透大卷' },
                        { value: n3, name: '3.硅纸' },
                        { value: n4, name: '4.塑纸' }
                    ],
                    emphasis: {
        ...
        myChart2.on('click', function (params) {
            ...
            window.open('Web03MX.aspx?asite=' + v_site + '&type=bcp&dayType=' + v_name2);
        });
    </script>
</body>
</html>
