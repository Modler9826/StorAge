<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web03YL.aspx.cs" Inherits="StorAge.Web03YL" %>
...
<body>
    ...
    <script type="text/javascript">   
        ...
        //数据来源
        var n1 = $("#HiddenField2").val();  //原纸
        var n2 = $("#HiddenField3").val();  //化工
        var n3 = $("#HiddenField4").val();  //胶水
        var n4 = $("#HiddenField5").val();  //膜(自产)
        var n5 = $("#HiddenField6").val();  //膜(外购)

        var n6 =  $("#HiddenField7").val(); //1-15
        var n7 =  $("#HiddenField8").val(); //16-30
        var n8 =  $("#HiddenField9").val(); //31- 90
        var n9 =  $("#HiddenField10").val(); //90-180
        var n10 = $("#HiddenField11").val(); //>180
        var n11 = $("#HiddenField12").val(); //>其他
        ...
        option1 = {
            ...
            legend: {
                orient: 'vertical',
                left: 'left',
                data: ['1.原纸', '2.化工', '3.胶水', '4.膜(自产)','5.膜(外购)']
            },
            series: [
                {
                    name: '数据明细',
                    ...
                    data: [
                        ...
                        { value: n2, name: '2.化工' },
                        { value: n3, name: '3.胶水' },
                        { value: n4, name: '4.膜(自产)' },
                        { value: n5, name: '5.膜(外购)' }
                    ],
                    emphasis: {
                        itemStyle: {
                            shadowBlur: 10,
            ...
            color:
                ['#c23531', '#2f4554', '#ff9f7f', '#759aa0','#91c7ae']
            ...
            series: [
                {
                    ...
                    data: [
                        { value: n6, name: '1-15天' },
                        { value: n7, name: '16-30天' },
                        { value: n8, name: '31-90天' },
                        { value: n9, name: '91-180天' },
                        { value: n10, name: '181天及以上' },
                        { value: n11, name: '其他' }
                    ],
                    emphasis: {
                        itemStyle: {
        ...
        myChart1.on('click', function (params) {
            ...
            if (v_name1.substring(0,1) == '1') {
                ...
                v_name1 = "yjs";
            } else if (v_name1.substring(0, 1) == '4') {
                v_name1 = "ymz";
            } else {
                v_name1 = "ymw";
            }
        ...
        myChart2.on('click', function (params) {
            ...
            window.open('Web03MX.aspx?asite=' + v_site + '&type=yl&dayType=' + v_name2);
        });
    </script>
</body>
</html>
